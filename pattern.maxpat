{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s enable_loopmode",
					"fontsize" : 9.0,
					"patching_rect" : [ 553.0, 248.0, 89.0, 17.0 ],
					"id" : "obj-60",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print #2_reset_filter",
									"fontsize" : 12.0,
									"patching_rect" : [ 953.0, 366.0, 113.0, 20.0 ],
									"id" : "obj-40",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print #1_filter.gatevalue",
									"fontsize" : 12.0,
									"patching_rect" : [ 538.0, 130.0, 135.0, 20.0 ],
									"id" : "obj-39",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print #1_filter.bypass_input",
									"fontsize" : 12.0,
									"patching_rect" : [ 361.0, 137.0, 154.0, 20.0 ],
									"id" : "obj-37",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"fontsize" : 12.0,
									"patching_rect" : [ 510.0, 14.0, 79.0, 20.0 ],
									"id" : "obj-36",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 1
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print pattrnumber",
									"fontsize" : 12.0,
									"patching_rect" : [ 510.0, 45.0, 102.0, 20.0 ],
									"id" : "obj-18",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print pattrpagenumber",
									"fontsize" : 12.0,
									"patching_rect" : [ 473.0, 75.0, 129.0, 20.0 ],
									"id" : "obj-17",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print #1_filter.loopoff",
									"fontsize" : 12.0,
									"patching_rect" : [ 193.0, 462.0, 119.0, 20.0 ],
									"id" : "obj-16",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "print #1_filter.filter_input",
									"fontsize" : 12.0,
									"patching_rect" : [ 124.0, 137.0, 139.0, 20.0 ],
									"id" : "obj-14",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 321.5, 119.0, 133.5, 119.0 ]
								}
