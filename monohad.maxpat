	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "set $1",
					"numinlets" : 2,
					"patching_rect" : [ -3.0, 1103.0, 35.0, 15.0 ],
					"id" : "obj-98",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "- 1",
					"numinlets" : 2,
					"patching_rect" : [ -3.0, 1078.0, 27.0, 17.0 ],
					"id" : "obj-94",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 288.0, 51.0, 969.0, 686.0 ],
						"bglocked" : 0,
						"defrect" : [ 288.0, 51.0, 969.0, 686.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "+ 1",
									"numinlets" : 2,
									"patching_rect" : [ 258.0, 75.0, 29.0, 18.0 ],
									"id" : "obj-3",
									"fontname" : "Arial",
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
...
, 							{
								"box" : 								{
									...
									"text" : "symbol test1",
									"numinlets" : 2,
									"patching_rect" : [ 201.0, 299.0, 87.0, 15.0 ],
									"id" : "obj-312",
									"fontname" : "Arial",
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"text" : "dinar8",
									"numinlets" : 2,
									"patching_rect" : [ 220.0, 404.0, 48.0, 15.0 ],
									"id" : "obj-93",
									"fontname" : "Arial",
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 267.0, 224.0, 373.0, 224.0, 373.0, 534.0, 307.0, 534.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-5", 0 ],
									"hidden" : 0,
									"midpoints" : [ 253.5, 211.0, 406.5, 211.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ 52.552643, 835.0, 68.0, 14.0 ],
					"id" : "obj-299",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "t b 1 clear",
					"numinlets" : 1,
					"patching_rect" : [ 53.0, 801.114746, 105.0, 16.0 ],
					"id" : "obj-309",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "LOAD ALL",
					"presentation_rect" : [ 349.0, 515.0, 52.0, 17.0 ],
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "pictctrl",
					"presentation_rect" : [ 355.0, 527.0, 36.0, 15.0 ],
					"trackvertical" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"items" : [ "<(unnamed)>", ",", "dinar8", ",", "dinar16", ",", "<(unnamed)>", ",", "<(unnamed)>", ",", "test1", ",", "<(unnamed)>" ],
					"numinlets" : 1,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 6.5, 1124.0, 47.5, 1124.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 105.5, 828.0, 30.0, 828.0, 30.0, 1055.0, 85.914459, 1055.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-246", 0 ],
					"hidden" : 0,
					"midpoints" : [ 47.5, 1231.0, 153.0, 1231.0, 153.0, 885.0, 62.5, 885.0 ]
				}
